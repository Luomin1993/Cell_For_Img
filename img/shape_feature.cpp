...
#include <iostream>  
#include <stdio.h>  
//g++ -I/usr/local/opencv2/include/ -o shape_feature shape_feature.cpp  -L/usr/local/opencv2/lib -lopencv_objdetect -lopencv_shape -lopencv_stitching -lopencv_superres -lopencv_videostab -lopencv_calib3d -lopencv_features2d -lopencv_highgui -lopencv_videoio -lopencv_imgcodecs -lopencv_video -lopencv_photo -lopencv_imgproc -lopencv_flann -lopencv_core -lopencv_nonfree
using namespace std;  
using namespace cv;  
...
{  
    ...
    cv::Canny(src,dst,120,255);
    //namedWindow("sobel", CV_WINDOW_AUTOSIZE );  
    //imshow("sobel", dst );
    //waitKey(0);
    save_pca_vec_to_csv_file(dst,"./shape.csv"); 
    return 0;
}  
